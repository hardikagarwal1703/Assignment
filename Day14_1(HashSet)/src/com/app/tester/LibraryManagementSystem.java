...
public class LibraryManagementSystem {
	...
	public static void main(String[] args) {
		try(Scanner scan = new Scanner(System.in)){
			...
			HashSet<Book> bookSet = BookSet.populateHashSet();
			boolean exit = false;
				...
				try {
					...
					switch(Integer.parseInt(scan.nextLine())) {
						case 1:
								...
								Book checkBook = new Book(bookTitle);
								if(!bookSet.contains(checkBook)) {
									...
									bookSet.add(new Book(bookTitle, 
						...
						case 3:
								...
								checkBook = bookSet.get(bookTitle);
								if(checkBook == null) {
